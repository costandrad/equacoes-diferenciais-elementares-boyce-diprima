      ...
      rect(width: 100%, radius: 5pt, stroke: primary-color, inset: 10pt)[
        #grid(
          ...
          align(horizon+center)[
            #text(fill: primary-color, size: 13.5pt, weight: "bold")[#book.title]\
            
            #text(fill: black, weight: "light", size: 12pt)[#book_authors]\

            #text(weight: "bold")[Resoluções por]\

            #text(fill: akared, size: 13.5pt, weight: "bold")[#author]\
          ],
          align(horizon+right)[
            //#image("assets/images/icone.svg", height: 3cm)
            #image("assets/images/cover.png", height: 3cm)
