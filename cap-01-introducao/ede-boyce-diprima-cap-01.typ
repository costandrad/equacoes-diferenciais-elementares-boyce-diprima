  ...
  book: (
    ...
    authors: (
      (
        ...
        short-name: "Boyce, W. E.",
      ),
      (
        name: "Richard C. DiPrima",
        short-name: "DiPrima, R. C.",
      ),
      (
        name: "Douglas B. Meade",
        short-name: "Meade, D. B.",
      ),
    ),
    chapter: (
      number: 1,
...
Em cada um dos Priblemas 1 a 4, desenhe um campo de direções para a equação diferencial dada. Baseao no campo de direções, determine o comportamento de $y$ quandp $t -> infinity$. Se esse comportamento depender do valor inicial de $y$ em t = 0, descreva essa tendência.
...
+ $y^' = 3 - 2y$
  #solution([
    ...
    Note que, para $y < 3\/2$, temos $y^' > 0$, ou seja, as soluções são crecentes; e, $y > 3\/2$, temos $y^' < 0$, ou seja, as soluções são decrescentes. Portanto, a solução de equilíbrio é um atrator, conforme ilustra o campo de direções abaixo:
